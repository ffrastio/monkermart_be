        ...
        <div class="card-body card-block">
            <form action="{{ route('barang.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="hargabeli" value="{{ old('hargabeli') }}" class="form-control @error('hargabeli') is-invalid @enderror">
                    @error('hargabeli')
                    <div class="text-muted">{{ $message }}</div>
                    @enderror
                </div>
                <div class="form-group">
                    ...
                    <input type="number" name="hargajual" value="{{ old('hargajual') }}" class="form-control @error('hargajual') is-invalid @enderror">
                    @error('hargajual')
                    <div class="text-muted">{{ $message }}</div>
                    @enderror
                </div>
